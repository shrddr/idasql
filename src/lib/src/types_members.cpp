...
// Convert the type-only form exposed by types_members into a C declaration
// that parse_decl can consume. In particular, `char[256]` needs its synthetic
// name inserted before the array suffix: `char __idasql_member[256];`.
